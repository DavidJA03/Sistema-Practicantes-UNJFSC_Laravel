...
@if ($etapa == 1)
    @include('practicas.admin.convalidacion.conv_E1')
@elseif ($etapa == 2)
    @include('practicas.admin.convalidacion.conv_E2')
@elseif ($etapa == 3)
    @include('practicas.admin.convalidacion.conv_E3')
@elseif ($etapa == 4)
    @include('practicas.admin.convalidacion.conv_E4')
@else
